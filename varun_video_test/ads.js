...
Ads.prototype.SAMPLE_AD_TAG = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dskippablelinear&correlator=';
...
/*
  ...
  adTagUrl:'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external'+
            '/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed'+
            '_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dskippablelinear&correlator='


  adTagUrl:'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/175265624/'+
			'vast_test&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start'+
			'=1&url=[referrer_url]&description_url=[description_url]&correlator=[timestamp]'
  adTagUrl: 'https://googleads.g.doubleclick.net/pagead/ads?client=ca-video'+
             '-pub-4631387039185633&slotname=3539573776&ad_type=video&description_url'+
             '=http%3A%2F%2Fwebdunia.com&videoad_start_delay=0&type=all'
*/
