...
(function() {
	...
	var putAd = function(container){
		...
		setAttributes(iframe, {"hov-data-host": window._pm_object.host, "hov-data-section": window._pm_object.section, "hov-data-wom": window._pm_object.web_or_mobile, "hov-data-id": _window_dataObject.id, "hov-data-default": _window_dataObject.is_default});
	...
	var initialize = function(){
      ...
      try{
        ...
        //do nothing
			...
			if(window._pm_object === undefined || window._pm_object.mobile_below_content_300x250 == undefined) return;
			else _window_dataObject = window._pm_object.mobile_below_content_300x250;
