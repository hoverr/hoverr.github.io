	...
	var initialize = function(){
      ...
      try{
        ...
        //do nothing
			...
			if(window._pm_object === undefined || window._pm_object.web_below_content_300x250 == undefined) return;
			else _window_dataObject = window._pm_object.web_below_content_300x250;
