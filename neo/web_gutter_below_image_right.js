	...
	var initialize = function(){
      ...
      try{
        ...
        //do nothing
			...
			if(window._pm_object === undefined || window._pm_object.web_gutter_below_image_right == undefined) return;
			else _window_dataObject = window._pm_object.web_gutter_below_image_right;
