	...
	var initialize = function(){
      ...
      try{
        ...
        //do nothing
			...
			if(window._pm_object === undefined || window._pm_object.web_normal_gutter_right == undefined) return;
			else _window_dataObject = window._pm_object.web_normal_gutter_right;
