		...
		intr = window.setInterval(function(){
			if($(_window_dataObject.selector).length != 0){
				...
				inline.each(function(){
					...
					children.eq(middleChild).before(containerDiv);
	...
	var initialize = function(){
      ...
      try{
        ...
        //do nothing
			...
			if(window._pm_object === undefined || window._pm_object.mobile_inline_320x50 == undefined) return;
			else _window_dataObject = window._pm_object.mobile_inline_320x50;
